...
```text
After 15 the numbers become too large for java to calculate with long
```
...
```text
Using BigInteger the calculation can go as high as the available memory will allow.
```
